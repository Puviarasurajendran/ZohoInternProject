...
/**
 * Servlet Filter implementation class InvalidInputFilter
 */
public class InvalidInputFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		chain.doFilter(request, response);
			   ...
			   out.println("<html><head>");
	            ...
	            out.println("<p style='color: red;'>Number1 Negative value can n't be acceptable</p>");
...
//	      System.out.println("<><><<><><><><><><><><>Filter Num1 is called<><><><><><><><><><><>");
		}
	   
		public void destroy() {
//			System.out.println("<><><<><><><><><><><><>Filter Num1 is destroy<><><><><><><><><><><>");
		}
